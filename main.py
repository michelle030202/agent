...
Examples:
  ...
  main.py run_multiple '[{"task_type": "dns_query", "params": {"domain": "example.com"}}, {"task_type": "http_request"
  , "params": {"method": "GET", "domain": "example.com", "port": 80, "path": "/"}}]'
...
if __name__ == "__main__":
    arguments = docopt(__doc__, version='Agent 1.0')
