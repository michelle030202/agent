...
class TaskManager:
    ...
    def __init__(self):
        ...
        self._tasks: Dict[str, Tuple[Type[Task], Type[TaskParameters]]] = {
            ...
            "process_tree_task": (ProcessTreeTask, ProcessTreeParameters)
        }
    ...
    def tasks(self) -> Dict[str, Tuple[Type[Task], Type[TaskParameters]]]:
        ...
        Returns:
            Dict[str, Tuple[Type[Task], Type[TaskParameters]]]: A dictionary mapping task names to their classes
    ...
    async def run_task(self, task_type: Union[str, List[Tuple[str, Dict[str, Any]]]], parameters: Dict[str, Any] = None) -> Any:
        ...
        Args:
            task_type (Union[str, List[Tuple[str, Dict[str, Any]]]]): A single task type or a list
            of tasks with their parameters.
